...
import 'package:project_delivery/providers/menu.dart' as menu;
...
class MenuTypePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final providerItems = Provider.of<menu.Menu>(context).items;
    final menuItems =
        providerItems.removeWhere((element) => element.type != menuType)
            as List<menu.MenuItem>;
    return Scaffold(
      appBar: AppBar(
        title: Text(menuType),
      ),
